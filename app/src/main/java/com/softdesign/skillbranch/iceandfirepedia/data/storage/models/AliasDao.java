...
public class AliasDao extends AbstractDao<Alias, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property CharacterRemoteId = new Property(2, Long.class, "characterRemoteId", false, "CHARACTER_REMOTE_ID");
    };

    private DaoSession daoSession;

    private Query<Alias> swornMember_AliasesQuery;
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ALIASES\" (" + //
                ...
                "\"ALIAS\" TEXT," + // 1: alias
                "\"CHARACTER_REMOTE_ID\" INTEGER);"); // 2: characterRemoteId
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Alias entity) {
        ...
        if (characterRemoteId != null) {
            stmt.bindLong(3, characterRemoteId);
        }
    }
    ...
    public Alias readEntity(Cursor cursor, int offset) {
        Alias entity = new Alias( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2) // characterRemoteId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Alias entity, int offset) {
        ...
        entity.setCharacterRemoteId(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
     }
    ...
    /** Internal query to resolve the "aliases" to-many relationship of SwornMember. */
    public List<Alias> _querySwornMember_Aliases(Long characterRemoteId) {
        synchronized (this) {
            if (swornMember_AliasesQuery == null) {
                QueryBuilder<Alias> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.CharacterRemoteId.eq(null));
                swornMember_AliasesQuery = queryBuilder.build();
            }
        }
        Query<Alias> query = swornMember_AliasesQuery.forCurrentThread();
